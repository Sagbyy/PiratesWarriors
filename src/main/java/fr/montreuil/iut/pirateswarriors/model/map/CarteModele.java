...
public class CarteModele {
    ...
    public void genererMap(String fileCsvName) {
        ...
        BufferedReader file = new BufferedReader(new InputStreamReader(Objects.requireNonNull(getClass().getResourceAsStream("/fr/montreuil/iut/pirateswarriors/MapCSV/" + fileCsvName))));
